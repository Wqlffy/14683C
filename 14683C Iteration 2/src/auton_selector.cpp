...
#include "liblvgl/widgets/image/lv_image.h"   // image widget
#include "main.h"
#include "lemlib/api.hpp"
#include <cstdio>   // snprintf
#include <cmath>    // for theta conversion if needed
#include <cstdint>  // intptr_t

extern lemlib::Chassis chassis;

// image descriptor defined in 14683C.c
...
// Timer callback to update pose.x, pose.y, pose.theta on screen
...
void build_auton_selector() {
    ...
    // Optionally scale it (LVGL 8 image widget supports zoom if enabled)
    // lv_image_set_zoom(bg, 512); // 512 = 1.0x, 256 = 0.5x, 768 = 1.5x, etc.
